...
![tests: 312 passed](https://img.shields.io/badge/tests-312%20passed-16a34a)
...
Name-based detection also recognizes families such as `gpt-image`, `dall-e`, `imagen`, `google-flow`, `omni`, `flux`, `stable-diffusion`, `sdxl`, `sora`, `veo`, `runway`, `kling`, `wan`, and `video`.
...
- Added benchmark chart generation for swarm-vs-single coverage, requested model comparisons, and the full CLI verification matrix.
- Raised regression coverage to 312 passing tests.
