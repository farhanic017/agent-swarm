...
AGENT_SPECS: tuple[AgentSpec, ...] = (
    ...
    AgentSpec("photo_editor", "Image Edit Agent", "see", "creative", "Plans and critiques image edits, crops, retouching, masking, restoration, and asset polish.", ("image critique", "retouch plans", "masking guidance", "asset QA"), COMMON_COLLAB_TOOLS, 0.3, "vision"),
    AgentSpec("video_editor", "Video Edit Agent", "see", "creative", "Plans cuts, pacing, captions, transitions, color, thumbnails, and video polish.", ("story pacing", "caption review", "timeline QA", "motion notes"), COMMON_COLLAB_TOOLS, 0.3, "vision"),
