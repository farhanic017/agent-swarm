...
def render_coding_models_chart(report: dict, path: Path) -> None:
    ...
    points = build_comparison_card_points(report)
    cards = [
        ((26, 6, 606, 554), "SciCode", "AA scientist-curated coding score - Higher is better", "swe_bench_pro", True, (124, 58, 237)),
        ((640, 6, 1220, 554), "Terminal-Bench", "AA Terminal-Bench Hard score - Higher is better", "terminal_bench", True, (250, 204, 21)),
        ((1254, 6, 1834, 554), "Coding Index", "Artificial Analysis aggregate coding index", "coding", True, (249, 115, 22)),
    ]
    for box, title, subtitle, metric, higher_better, accent in cards:
        draw_metric_card(image, draw, box, title, subtitle, metric, points, higher_better, accent)
    image.save(path)
